...
wget -q -O /etc/pam.d/common-password "https://raw.githubusercontent.com/myridwan/asd/ipuk/password"
...
wget -q -O /usr/local/bin/ws-dropbear "https://raw.githubusercontent.com/myridwan/asd/ipuk/ws-dropbear"
...
wget -q -O /usr/local/bin/ws-stunnel "https://raw.githubusercontent.com/myridwan/asd/ipuk/ws-stunnel"
...
wget -q -O /usr/bin/badvpn-udpgw "https://raw.githubusercontent.com/myridwan/asd/ipuk/newudpgw"
...
# Install Stunnel5
cd /root/
wget -q "https://raw.githubusercontent.com/myridwan/asd/ipuk/stunnel5.zip"
unzip stunnel5.zip
cd /root/stunnel
chmod +x configure
./configure
...
wget -q -O /etc/init.d/stunnel5 "https://raw.githubusercontent.com/myridwan/asd/ipuk/stunnel5.init"
...
wget -q -O /etc/issue.net "https://raw.githubusercontent.com/myridwan/asd/ipuk/issue.net"
